...
CSVData::CSVData (CSVData& rhs)
    : m_is_modified (rhs.is_modified ()), m_is_unified (rhs.is_unified ()), m_rows (rhs.m_rows), m_cols (rhs.m_cols) {}
...
void CSVData::delete_row_if (function<bool (int, const std::vector<std::string>&, void* cbData)> cbFun, void* cbData) {
...
void CSVData::delete_row_if (function<bool (int, int, const std::string&)> cbFun) {
    function<bool (int, int, const std::string&, void* cbData)> simple_delete_row_if = [=] (int row, int col, const std::string& val,
                                                                                            void* cbData) {
