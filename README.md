...
*NAPONENA: ve komande su konfigurisane tako da nakon uspješne instalacije brišu sve privremene build fajlove i izvršne fajlove testova, ostavljajući samo izvršne fajlove u `build/bin` folderu