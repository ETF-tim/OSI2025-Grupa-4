...
enum class WorkOrderStatus { UNKNOWN, IN_DIAGNOSTICS, IN_REPAIR, WAITING_FOR_PARTS, COMPLETED };
...
class WorkOrder {
    ...
    public:
        WorkOrder ();
        WorkOrder (int id, int receiptOrderID, WorkOrderStatus status, const std::string& comment, std::time_t startDate,
        ...
        const std::map<int, int>& getUsedParts () const;
